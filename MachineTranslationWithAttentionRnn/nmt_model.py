...
class NMT(nn.Module):
    ...
    def __init__(self, embed_size, hidden_size, vocab, dropout_rate=0.2):
        ...
        self.target_vocab_projection = nn.Linear(embed_size,hidden_size,bias=False)
    ...
    def encode(self, source_padded: torch.Tensor, source_lengths: List[int]) -> Tuple[torch.Tensor, Tuple[torch.Tensor, torch.Tensor]]:
        ...
        enc_emb=self.model_embeddings.source(source_padded)
        enc_emb_pack=pack_padded_sequence(enc_emb,source_lengths)
        enc_hiddens,(last_hidden,last_cell)=self.encoder(enc_emb_pack)
    ...
    def decode(self, enc_hiddens: torch.Tensor, enc_masks: torch.Tensor,
        ...
        for Y_ in torch.split(Y,1):
            Y_t = torch.squeeze(Y_)
    ...
    def step(self, Ybar_t: torch.Tensor,
        ...
        e_t = torch.bmm(enc_hiddens_proj,torch.unsqueeze(dec_hidden,2)).squeeze()
